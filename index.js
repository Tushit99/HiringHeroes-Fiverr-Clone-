...
document.getElementById("loginSection").addEventListener("click", function(){
    window.location.href = "./logo/logo-page.html" ; 
}) ; 

document.getElementById("fontSection").addEventListener("click", function(){
    window.location.href = "./FontPage/font-page.html" ; 
}) ; 


document.getElementById('brand_section').onclick=()=>{
    window.location.href='./brand-style/brand-style.html'


}

document.getElementById('business_section').onclick=()=>{
